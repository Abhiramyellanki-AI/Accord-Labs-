  ...
  return (
    <div className="min-h-screen bg-neutral font-sans">
      ...
      <main className="max-w-7xl mx-auto px-8 py-20 grid lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <div className="flex gap-4">
            <button 
              onClick={onGetStarted}
              className="bg-primary text-white px-8 py-4 rounded-xl font-semibold flex items-center gap-2 hover:bg-secondary transition-all shadow-lg shadow-slate-200"
            >
              Get Started <ArrowRight className="w-5 h-5" />
            </button>
            <button className="bg-white text-primary px-8 py-4 rounded-xl font-semibold border border-slate-200 hover:bg-slate-50 transition-all">
              Watch Demo
            </button>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="absolute -bottom-6 -left-6 bg-tertiary text-white p-6 rounded-2xl shadow-xl max-w-xs">
      ...
      <section className="bg-white py-24 mt-20">
        <div className="max-w-7xl mx-auto px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-primary mb-4">Why Our App?</h2>
            <p className="text-secondary">The sovereign intelligence engine built for federal compliance.</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <motion.div 
                ...
                viewport={{ once: true }}
                className="p-8 rounded-2xl bg-neutral border border-slate-100 hover:border-primary transition-all group"
              >
                <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center mb-6 shadow-sm group-hover:bg-primary transition-colors">
      ...
      <section className="py-24 max-w-7xl mx-auto px-8">
        <div className="bg-primary rounded-[40px] p-16 text-center text-white relative overflow-hidden">
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <button 
                onClick={onGetStarted}
                className="bg-tertiary text-white px-8 py-4 rounded-xl font-bold hover:bg-red-600 transition-all"
              >
                Get Started
              </button>
            </div>
